...
export default function Hero() {
  return (
    <section className="w-full py-20 px-4 sm:px-8 lg:px-16 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
        
        {/* Left Content */}
        <div className="flex-1 text-center lg:text-left animate-fadeIn">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold mb-6 leading-snug">
            Web Development &{" "}
          ...
          <p className=" text-base sm:text-lg mb-10 max-w-2xl mx-auto lg:mx-0">
