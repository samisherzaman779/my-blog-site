  ...
  return (
    <header className="bg-gray-300 shadow-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto flex justify-between items-center py-4 px-6">
        {/* Logo */}
        <h1 className="text-2xl font-bold text-blue-600">TechXiz-Solutions</h1>
        ...
        <nav className="hidden md:flex space-x-6 text-bold text-gray-100 mx-1.5">
          ...
          <Link href="/contact" className="hover:text-blue-300"><span className="text-lg text-black hover:text-gray-300"> Contact </span></Link>
        </nav>
